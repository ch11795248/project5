    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <shiro:hasPermission name="perm:query">
                    <li>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/user.jpg"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Joe Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar2.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Jim Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar5.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar3.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar4.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar"
                                                                     src="${pageContext.request.contextPath}/ace/assets/avatars/avatar1.png"/>
                                                            </div>
                                            ...
                                            <div class="dialogs">
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    ...
                                                    <div class="body">
                                                        ...
                                                        <div class="text">wanho框架很好用嘛</div>
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    ...
                                                    <div class="body">
                                                        ...
                                                        <div class="text">欢迎大家使用wanho后台管理系统.</div>
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    ...
                                                    <div class="body">
                                                        ...
                                                        <div class="text">继续支持wanho后台系统</div>
